...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:
    cc -o ip_coursework ip_coursework_027.c -lglut -lGL -lm -pthread
...
void detect_edges(unsigned char *in, unsigned char *out,R_thread *args) {
  int i;
